...
<title>Myplace-reset-password</title>
...
<div style=" width:98%; margin:auto; margin-top:50px; margin-bottom:10px;">Please fill in your new password to reset your password<br /></div>
  ...
  <div style=" width:98%; float:left; margin-top:15px; margin-right:10px;">NEW PASSWORD</div><div style="width:98%; margin-top:2px; float:left;"><label><input type="password" name="password" class="textfield" maxlength="50" /></label></div>
  <div style=" width:98%; float:left; margin-top:15px; margin-right:10px;">PLEASE RE-ENTER YOUR PASSWORD</div><div style="width:98%; margin-top:2px; float:left;"><label><input type="password" name="confPassword" class="textfield" maxlength="50" /></label></div>
