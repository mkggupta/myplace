...
public class AdvertisementInfo {
	...
	public void setAdvtDesc(String advtDesc) {
		this.advtDesc = advtDesc;
	}
	...
	public int getAdvtHasFileId() {
		return advtHasFileId;
	}
	public void setAdvtHasFileId(int advtHasFileId) {
		this.advtHasFileId = advtHasFileId;
	}
